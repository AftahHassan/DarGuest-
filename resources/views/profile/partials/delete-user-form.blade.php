<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-surface-600">
            {{ __('Une fois votre compte supprimé, toutes ses ressources et données seront définitivement effacées. Avant de supprimer votre compte, téléchargez toute information que vous souhaitez conserver.') }}
        </p>
    </header>
    ...
    >{{ __('Supprimer le compte') }}</x-button>
