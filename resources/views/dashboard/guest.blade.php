        ...
        <div data-aos="fade-up">
            <div class="flex items-center justify-between mb-5">
                <div>
                    ...
                    <h2 class="mt-2 text-lg font-semibold text-surface-900">Recommandations</h2>
                </div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div class="group bg-white/60 backdrop-blur-sm border border-surface-200/60 rounded-2xl p-5 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 hover:border-navy-200/50 flex items-center gap-4">
                    <div class="w-12 h-12 rounded-xl bg-navy-50 flex items-center justify-center group-hover:bg-navy-100 transition-colors flex-shrink-0">
                        <svg class="w-6 h-6 text-navy-700" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
