...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-navy-500 text-sm font-medium leading-5 text-surface-900 focus:outline-none focus:border-navy-700 transition duration-150 ease-in-out'
